...
model_name_aug = 'CNN_scratch_dropout_aug_callbacks.h5'
model_weights = 'CNN_scratch_dropout_aug_weights.h5'
model_weights_data_aug = 'CNN_scratch_dropout_aug__callbacks_weights.h5'
num_classes = 95
...
plt.savefig(os.path.join(saved_path, 'train_test_accuracy_dropout_aug_callbacks.png'))
...
plt.savefig(os.path.join(saved_path, 'train_test_loss_dropout_aug_callbacks.png'))
plt.clf()
