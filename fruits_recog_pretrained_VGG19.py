...
CNN_base = VGG19(weights='imagenet',include_top=False, input_shape=(100,100,3))
...
model_name_aug = 'CNN_pretrained_VGG19_aug.h5'
model_weights_data_aug = 'CNN_pretrained_VGG19_aug_weights.h5'
model_name = 'CNN_pretrained_VGG19.h5'
model_weights = 'CNN_pretrained_VGG19_weights.h5'
finetuning_model_name_aug = 'CNN_finetuning_pretrained_VGG19_aug.h5'
finetuning_model_weights_data_aug = 'CNN_finetuning_pretrained_VGG19_aug_weights.h5'
finetuning_model_name = 'CNN_finetuning_pretrained_VGG19.h5'
finetuning_model_weights = 'CNN_finetuning_pretrained_VGG19_weights.h5'
num_classes = 95
...
plt.savefig(os.path.join(saved_path, 'train_test_accuracy_VGG19.png'))
...
plt.xlabel('Epochs')
plt.legend(['train', 'test'], loc='upper right')
plt.savefig(os.path.join(saved_path, 'train_test_loss_VGG19.png'))
plt.clf()
