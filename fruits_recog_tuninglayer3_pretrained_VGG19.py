...
model_name_aug = 'CNN_finetuning_pretrained_VGG19_aug.h5'
model_weights_data_aug = 'CNN_finetuning_pretrained_VGG19_aug_weights.h5'

# name of model and weights when tuning from layer 3 of VGG16
tuninglayer3_model_name_aug = 'CNN_tuninglayer3_pretrained_VGG19_aug.h5'
tuninglayer3_model_weights_data_aug = 'CNN_tuninglayer3_pretrained_VGG19_aug_weights.h5'
...
plt.savefig(os.path.join(saved_path, 'train_test_accuracy_tuninglayer3_VGG19.png'))
...
plt.savefig(os.path.join(saved_path, 'train_test_loss_tuninglayer3_VGG19.png'))
plt.clf()
