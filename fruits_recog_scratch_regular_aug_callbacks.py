...
model_name = 'CNN_scratch_regular.h5'
model_name_aug = 'CNN_scratch_regular_aug_callbacks.h5'
model_weights = 'CNN_scratch_regular_aug_weights.h5'
model_weights_data_aug = 'CNN_scratch_regular_aug_callbacks_weights.h5'
num_classes = 95
...
model = Sequential()
model.add(Conv2D(32, (3,3), padding='same', input_shape=(100,100,3), kernel_regularizer=regularizers.l2(0.0001)))
...
plt.savefig(os.path.join(saved_path, 'train_test_accuracy_regular_aug_callbacks.png'))
...
plt.savefig(os.path.join(saved_path, 'train_test_loss_regular_aug_callbacks.png'))
plt.clf()
