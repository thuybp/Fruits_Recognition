...
for layer in CNN_ResNet.layers[-1:-91]:
...
plt.savefig(os.path.join(saved_path, 'train_test_accuracy_finetuning_ResNet50.png'))
...
plt.savefig(os.path.join(saved_path, 'train_test_loss_finetuning_ResNet50.png'))
plt.clf()
